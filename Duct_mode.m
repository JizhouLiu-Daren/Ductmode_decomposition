%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%This code could perform cylindrical duct mode decomposition 
%Convective mean flow effect could be taken into consideration
%This code has not been verified so it possibly contains bugs
%BessDerivZerosBisect2 function is from Carey Smith: https://www.mathworks.com/matlabcentral/fileexchange/28001-bessel-derivative-zeros
%Created by: Daren Liu, jizhou.liu@buaa.edu.cn
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
